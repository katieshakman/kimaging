...
% groupFileString = 'Dirs_OILvsIPA_V1vsMV1.txt' ;% user specifies this file 
groupFileString = 'Dirs_OILvsIPA_V1.txt' ;% user specifies this file 
pathToAdd = '/Users/katieshak/Dropbox/Axel Lab Dropbox/JClub and LM Papers and Notes/MyPresentations/Fall2016/';
addpath(genpath(pathToAdd));
addpath(genpath('/Users/katieshak/Desktop/Data_Analysis_Temp/Data_Analysis/2015_10_13_Live/br1_58B_6fA/p1_hemi1'));
...
subplot( numFlies,numOdors, plotindex(splotNum))
        hold on
        ...
        try
            ...
            plot(tPtsDat,avgTrace,'Color','w','LineWidth',1.5);
            ylim([yaxmin, yaxmax]);
            xlim([xaxmin, xaxmax]);
...
%% Save Figure as PNG
gfig.Color = 'black';
gfig.InvertHardcopy = 'off';
saveas(gfig,'Grid.png')
